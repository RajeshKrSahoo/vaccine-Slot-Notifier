...
def gspreadData():
    ...
    sheet_id='1D8uhTHBZyWIsQiRpzClFLrgmZ2VNjISqekCXxxFC6z4'
...
def tweet_data(msg):
    ...
    CONSUMER_KEY='IBu5NlEsmDo0EaRy5'
    CONSUMER_SECRET='VvaMJUrmpHTSYAptFEM6wOIDfFAGEhPl5VDrOaI'
    Access_Token='1389932uKKcvsWg6u3jZiSmRqGVxyCsHr'
    Access_Token_Secret='8fWjdgOvGhYaOJqKtBjb3oxqVLkmrG'
...
#             print([covs_45,covx_45,covs_18,covx_18])
            if all(v == 0 for v in [covs_18,covs_18_d2,covx_18,covx_18_d2]):
...
# https://docs.google.com/spreadsheets/d/1D8uhTHBZyWIsQiRpzClFLrgmZ2VNjISqekCXxxFC6z4/edit#gid=0
